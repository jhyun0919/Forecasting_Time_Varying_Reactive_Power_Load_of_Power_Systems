...
write_file = '/Users/JH/Documents/GitHub/Forecasting_Time_Varying_Reactive_Power_Load_of_Power_Systems/data/elm_optimal4q.csv';
...
for x = 1:100
    ...
    MAE_temp = [];
    for xx = 1:30
        [TrainingTime, TestingTime, TrainingAccuracy_RMSE, TestingAccuracy_RMSE, TrainingAccuracy_MAPE, TestingAccuracy_MAPE, TrainingAccuracy_MAE, TestingAccuracy_MAE, predict_p] = ELM_MultiOutputRegression(train_q, val_q, No_of_Output, NumberofHiddenNeurons, ActivationFunction);
