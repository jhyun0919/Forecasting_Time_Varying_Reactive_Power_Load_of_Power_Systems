function [Training_time,Testing_time, TrainingAccuracy_RMSE, TestingAccuracy_RMSE, TrainingAccuracy_MAPE, TestingAccuracy_MAPE, TrainingAccuracy_MAE, TestingAccuracy_MAE, predict_yy] = helm_regression_layer2(TrainingData, TestingData, No_of_Output, N1, N2, N3)
...
[T, l, beta] = elm_train(train_y, T3, b, s, C);
clear T3;
...
predict_yy = (elm_test(TT3, beta, l, b))';
clear TT3; clear b;
